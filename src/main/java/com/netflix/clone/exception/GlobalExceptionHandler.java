...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleResourceNotFound(ResourceAccessException ex) {
        log.warn("ResourceAccessException: {", ex.getMessage(),ex);
    ...
    public void handleClientAbort(Exception ex){
        log.debug("Client closed connection during streaming (expected for viedo seeking/buffering):{}",ex.getMessage());
    ...
    private ResponseEntity<Map<String, Object>> buildResponse(HttpStatus status, String message) {
        Map<String,Object> body =Map.of("timestamp", Instant.now(),"erro", message);
